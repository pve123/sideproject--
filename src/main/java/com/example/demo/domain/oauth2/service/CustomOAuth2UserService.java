package com.example.demo.domain.oauth2.service;
...
public class CustomOAuth2UserService extends DefaultOAuth2UserService {
    ...
    public OAuth2User loadUser(OAuth2UserRequest userRequest) throws OAuth2AuthenticationException {
        ...
        System.out.println("SNS : " + userRequest.getClientRegistration().getRegistrationId()); // SNS Type
        ...
        System.out.println("Resp Body : " + response.getBody());  // Resp Data
